...
export default function Appraiser({ route }) {
  ...
  return (
    <ImageBackground source={require('../assets/apprai.jpg')} style={styles.container}>
      <StatusBar
        backgroundColor="#303234"
        barStyle="light-content"
      />

      <Text style={{ color: '#DDDDDD', width: width - 32, alignSelf: 'center', marginTop: insets.top + 100, fontStyle: 'italic', fontSize: 10 }}>{"I am an AI stamp expert. Take or select a stamp photo, it can be 1 or more stamps, send it to me, I will price all the stamps in the photo for you based on the condition and rarity in the market.\n\nMy values mostly reflect the actual value, you can refer to it to sell the stamps on the stamp exchanges."}</Text>
